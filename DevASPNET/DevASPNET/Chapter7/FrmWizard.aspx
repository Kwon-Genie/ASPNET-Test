<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmWizard.aspx.cs" Inherits="DevASPNET.FrmWizard" %>
        ...
        <div>
            <asp:Wizard ID="Wizard1" runat="server" Width="600px" Height="200px" BorderWidth="1px" OnFinishButtonClick="Wizard1_FinishButtonClick">
                <WizardSteps>
                    ...
                    <asp:WizardStep ID="WizardStep2" runat="server" Title="1. 단계 1" StepType="Step">
                        첫 번째 단계입니다.
                        <br />
                        1:
                        <asp:TextBox ID="txtStep1" runat="server"></asp:TextBox>
                    </asp:WizardStep>
                    <asp:WizardStep ID="WizardStep3" runat="server" Title="2. 단계 2" StepType="Step">
                        두 번째 단계입니다.
                        <br />
                        2:
                        <asp:TextBox ID="txtStep2" runat="server"></asp:TextBox>
                    </asp:WizardStep>
                    <asp:WizardStep ID="WizardStep4" runat="server" Title="3. 마지막" StepType="Finish">
                        마지막 단계입니다.
                        <br />
                        3:
                        <asp:TextBox ID="txtFinish" runat="server"></asp:TextBox>
                    </asp:WizardStep>
                    <asp:WizardStep ID="WizardStep5" runat="server" Title="4. 완료" StepType="Complete">
                        완료되었습니다.
                        <br />
