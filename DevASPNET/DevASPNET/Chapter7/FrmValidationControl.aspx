<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmValidationControl.aspx.cs" Inherits="DevASPNET.Chapter7.FrmValidationControl" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ol>
                ...
                <li>Global.aspx - Application_Start() : <br />
