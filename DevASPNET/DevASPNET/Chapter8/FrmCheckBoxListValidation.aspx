<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmCheckBoxListValidation.aspx.cs" Inherits="DevASPNET.Chapter8.FrmCheckBoxListValidation" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:CustomValidator ID="ValidateCheckBoxList1" runat="server" ErrorMessage="반드시 하나 이상을 체크하세요." ClientValidationFunction="CheckValue" ValidationGroup="MyForm" Display="None" />
            <asp:ValidationSummary runat="server" DisplayMode="List" ShowSummary="false" ShowMessageBox="true" ValidationGroup="MyForm" />
